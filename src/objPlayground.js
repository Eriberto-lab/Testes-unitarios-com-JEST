...
let obj = { sum: Math.floor(number1 + number2), 
...
// console.log(arrayGenerator('keys', calculator));
// console.log(arrayGenerator('values', calculator));
// console.log(arrayGenerator('entries', calculator));
